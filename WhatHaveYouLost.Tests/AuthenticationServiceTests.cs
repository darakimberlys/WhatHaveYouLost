...
using Moq;
using WhatHaveYouLost.Data.Repository.Configurations;
using WhatHaveYouLost.Model.Data;
...
namespace WhatYouHaveLost.Tests
{
    public class AuthenticationServiceTests
    {
        ...
        public async Task LoginAsync_ValidCredentials_ReturnsSuccess()
        {
            ...
            signInManagerMock.Setup(m => m.PasswordSignInAsync(It.IsAny<UserData>(), password, false, false))
